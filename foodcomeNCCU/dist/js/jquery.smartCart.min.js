    ...
    t.extend(s.prototype, {
        ...
        _setToolbar: function () {
            ...
            var e = t("<div></div>").addClass("panel-footer sc-toolbar"),
                ...
                p = t('<div ><select id="pay1" class="form-control input-sm" ><option value="" disabled selected>付款方式</option><option value="信用卡">信用卡</option><option value="現金">現金</option></select></div>'),

                g = t('<div ><select id="addr" class="form-control input-sm" style=" margin-top: 6px;"><option value="" disabled selected>地址</option><option value="大仁樓">大仁樓</option><option value="大智樓">大智樓</option><option value="大勇樓">大勇樓</option></select></div>'),
            ...
            e.append(i), e.append(p),e.append(g), e.append(a), this.cart_element.append(e)
        ...
        _setEvents: function (_len1) {
            ...
            t(this.options.addCartSelector).on("click", function (a) {
                ...
                if (name != 'undefined' && temp[1] != 'undefined') {
                    ...
                    var day = d.getDate();
                    var add = decodeURIComponent($('#addr').val())
                    var ppp1 = decodeURIComponent($('#pay1').val())
                    // alert(add)
                    ...
                    docRef.get().then(function (doc) {
                        if (doc.exists) {
                            ...
                            db.collection(name).doc(new1).set({
                                ...
                                .then(function () {
                                    alert('訂單成立，餐點將送達' + add +'以'+ppp1+'付款')
